...
function showElement() {
  ...
  console.log(this);
  console.log(this.chemicalObject);
  ...
  document.getElementById("atomicNumber").textContent =
    chemicalObject.atomicNumber.toString();
  document.getElementById("atomicWeight").textContent =
    chemicalObject.atomicWeight.toFixed(2);
  document.getElementById("symbol").textContent = chemicalObject.symbol;
  document.getElementById("name").textContent =
    chemicalObject.name.toUpperCase();
}
